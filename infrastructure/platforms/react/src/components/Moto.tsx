      ...
      <div className="bg-white w-full max-w-5xl p-8 rounded-lg shadow-xl relative">
        ...
        {!openCreateMaintenanceForm && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h4 className="text-lg font-semibold text-gray-800 mb-4 border-b pb-2">Historique des maintenances</h4>
              <div className="max-h-[500px] overflow-y-auto pr-2">
                {moto.maintenances
                  .sort((a, b) => new Date(b.scheduledDate).getTime() - new Date(a.scheduledDate).getTime())
                  .map((maintenance, index) => (
                    <div key={index} className="border border-gray-200 rounded-md p-4 mb-2 shadow-sm">
                      ...
                      <p className="text-gray-700">
                        <strong>Type :</strong> {maintenance.type === "CURATIVE" ? "Curatif" : "Préventif"}
                      </p>
                      <p className="text-gray-700">
            ...
            <div>
              ...
              {lastMaintenance && (
                <div className="mb-6 p-4 bg-gray-50 border border-gray-200 rounded-md shadow-sm">
                  ...
                  <p className="text-gray-700">
                    <strong>Type :</strong> {lastMaintenance.type === "CURATIVE" ? "Curatif" : "Préventif"}
                  </p>
                  <p className="text-gray-700">
              ...
              {nextMaintenanceScheduled && (
                <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-md shadow-sm">
                  <h4 className="text-lg font-semibold text-gray-800 mb-1">Prochain entretien programmé</h4>
                  <p className="text-gray-700">
                  ...
                  <p className="text-gray-700">
                    <strong>Type :</strong> {nextMaintenanceScheduled.type === "CURATIVE" ? "Curatif" : "Préventif"}
                  </p>
                  <p className="text-gray-700">
              ...
              {nextMaintenanceDatas && (
                <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-md shadow-sm">
                  ...
                  {nextMaintenanceDatas.nextScheduledDate && (
                    <p className="text-gray-700">
                      <strong>Date suivante :</strong> {formatDate(nextMaintenanceDatas.nextScheduledDate)}
                    </p>
                  )}
                </div>
              )}
