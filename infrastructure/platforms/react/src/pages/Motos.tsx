...
export const Motos = () => {
    ...
    return (
        <>
            ...
            {!openCreateMoto && (
                <>
                    <h2 className="text-xl font-bold mt-6 mb-4 border-b pb-2 text-gray-800">Motos disponibles :</h2>
                    {motos.length > 0 ? (
                        motos.map((moto) => (
                            <div
                                key={moto.id}
                            ...
                            >
                                ...
                                <p>
                                    <span className="font-semibold">Propriétaire: </span> {moto.owner?.name}{" "}
                                    {moto.owner?.email}
                                </p>
                            </div>
                        ))
